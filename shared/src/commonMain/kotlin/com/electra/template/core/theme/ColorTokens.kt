...
data class ColorTokens(
    ...
    companion object {
        val Light = ColorTokens(
            ...
            surface = 0xFFFFFFFF, onSurface = 0xFF1A1B1F,
            error = 0xFFBA1A1A, onError = 0xFFFFFFFF,
        )
        val Dark = ColorTokens(
            primary = 0xFFB1C5FF, onPrimary = 0xFF002B6F,
            background = 0xFF1A1B1F, onBackground = 0xFFE3E2E6,
            surface = 0xFF1A1B1F, onSurface = 0xFFE3E2E6,
